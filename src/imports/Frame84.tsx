import svgPaths from "./svg-barnetewzy";

function GrandTourSochi() {
  return (
    <div className="absolute inset-[78.7%_6.98%_10.79%_9.88%]" data-name="Grand Tour Sochi">
...
function Group() {
  return (
    <div className="absolute contents inset-[15.32%_6.25%_10.79%_9.08%]">
      <GrandTourSochi />
      <Gts />
    </div>
  );
